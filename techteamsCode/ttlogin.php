...
<head>
    ...
    <title>Tech Team User Login</title>
...
<div style="margin-top: 20px" class="container">
    ...
    <h1>Tech Team Login</h1>
    <form action="ttlogin.php" method="post">
...
if (!empty($_POST)) {
    if (isset($_POST['Submit'])) {
        ...
        $queryUser = "SELECT * FROM UserTesting  WHERE Uusername='$input_username' AND UPassword='$input_password'";
